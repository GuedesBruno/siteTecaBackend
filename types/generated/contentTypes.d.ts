...
export interface ApiBannerSiteBannerSite extends Struct.CollectionTypeSchema {
  collectionName: 'banner_sites';
  info: {
    displayName: 'Banner Site';
    pluralName: 'banner-sites';
    singularName: 'banner-site';
  };
  options: {
  ...
  attributes: {
    ...
    link_do_botao: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::banner-site.banner-site'
    > &
      Schema.Attribute.Private;
    ordem: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    subtitulo: Schema.Attribute.Text;
    texto_do_botao: Schema.Attribute.String;
...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galeria_de_imagens: Schema.Attribute.Media<
      ...
      true
    >;
    imagem_principal: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::banner-site.banner-site': ApiBannerSiteBannerSite;
